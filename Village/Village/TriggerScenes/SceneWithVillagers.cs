...
public class SceneWithVillagers : TriggerScene
{
    ...
    Queue<string> dialog1
    {
        get => new(new string[]
        {
            "Мясник: ... А я тебе говорю, что лошадь лучше!",
            "Дровосек: Нет, ишак лучше!",
            "Мясник: Да твой ишак тупой и медленный, а лошадь умная и быстрая.",
            "Дровосек: Ишак не тупой. Он простой и неприхотливый, в отличие от твоей лошади, с которой очень долго надо возиться, чтобы она начала работать!",
